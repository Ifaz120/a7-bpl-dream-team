...
const Player = ({card , handleSelectPlayer}) => {
  ...
  return (
    <div className=' mx-auto shadow-xl border-gray-300 p-6 rounded-xl'>
      <div className='flex flex-col gap-y-2'>
        <div >
        <img className='w-[380px] h-[240px] rounded-2xl'  src={image} alt="" />

        </div>
        <p className='flex gap-x-2 font-bold text-xl'><img className='w-7' src="https://img.icons8.com/?size=100&id=7820&format=png&color=000000" alt="" /> {name}</p>
        ...
        <div className='flex justify-between items-center'>
         ...
         <button onClick={() => {
           ...
           }} className='p-1 text-sm sm:text-base font-bold text-gray-400 cursor-pointer rounded-lg border-1 hover:bg-gray-200'>Choose Player</button>
